        ...
        <div class="row">
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <table>
                    ...
                    <?php
                    $qStr = "SELECT name, programID, max_date AS id FROM (SELECT programID, MAX(date_time) AS max_date FROM completed WHERE userID = '$uid' GROUP BY programID) AS uComp NATURAL JOIN program
                    ";
                    $qRes = $db->query($qStr);
                    if ($qRes == FALSE) {
