            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    for ($i = 0; $i < 6 && $row = $qRes->fetch(); $i++) {
                        ...
                        print "<form>\r\n";
                        print "<button formaction='http://www.cs.gettysburg.edu/~mirari01/cs360project/cs360-project/program-view.php/?id=1' type='submit' class='btn btn-sm btn-outline-secondary'>Rating of $rating. Try for free!</button> \r\n";
                        print "</form>\r\n";
                        print "</div> \r\n";
